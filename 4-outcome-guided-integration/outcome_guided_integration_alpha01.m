...
% Methylation data
load(strcat(folder_path, 'mdi/psms-mat/psm_methylation_average__alpha01_noCuda.mat'))
...
save(strcat(folder_path, 'outcome-guided-integration-output/outcome_guided_integration_alpha01_weights.mat'), 'beta');
