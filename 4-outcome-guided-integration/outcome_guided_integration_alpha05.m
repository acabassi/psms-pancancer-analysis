...
% mRNA data
load(strcat(folder_path, 'mdi/psms-mat/psm_mRNA_average__alpha05_temp.mat'))
all_psms(:,:,2) = average_psm;

% Methylation data
load(strcat(folder_path, 'mdi/psms-mat/psm_methylation_average__alpha05_noCuda.mat'))
...
save(strcat(folder_path, 'outcome-guided-integration-output/outcome_guided_integration_alpha05_weights.mat'), 'beta');
