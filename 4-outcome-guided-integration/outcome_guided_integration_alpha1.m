...
% mRNA data
load(strcat(folder_path, 'mdi/psms-mat/psm_mRNA_average__alpha1_temp.mat'))
all_psms(:,:,2) = average_psm;

% Methylation data
load(strcat(folder_path, 'mdi/psms-mat/psm_methylation_average__alpha1_noCuda.mat'))
all_psms(:,:,3) = average_psm;

% miRNA data
load(strcat(folder_path, 'mdi/psms-mat/psm_miRNA_average__alpha1_noCuda.mat'))
all_psms(:,:,4) = average_psm;

% Protein expression data
load(strcat(folder_path, 'mdi/psms-mat/psm_RPPA_average__alpha1_noCuda.mat'))
all_psms(:,:,5) = average_psm;
%% Response
...
save(strcat(folder_path, 'outcome-guided-integration-output/outcome_guided_integration_alpha1_weights.mat', 'beta'));
