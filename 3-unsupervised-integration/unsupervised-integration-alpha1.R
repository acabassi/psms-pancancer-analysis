...
#      file = paste0("integration-output/unsupervised_output_", i,
#                    var_sel, ".RData"))
...
our_cl_palette <-  c(
  "1" = "#93328E" , "2" = "#000000", "3" =  "#0072ce", "4" = "#D50032",
  "5" = "#af95a6", "6" = "#64A70B", "7" = "#f7dea3", "8" = "#B7BF10",
  "9" = "#0072ce", "10" ="#E89CAE", "11" = "#E47113", "12" = "#115E67",
  "13" = "#B7BF10", "14" = "#6CACE4", "15" = "#8C77A3"
)
...
pdf(paste0("../figures/unsupervised_weights_", bestK, "_", var_sel,".pdf"),
    height = 5,
    width = 6)
draw(
  Hweights,
