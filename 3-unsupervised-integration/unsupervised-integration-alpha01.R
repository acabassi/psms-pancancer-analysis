...
our_cl_palette <-  c(
  "1" = "#93328E" , "2" = "#D50032", "3" =  "#E47113", "4" = "#6CACE4",
  "5" = "#E89CAE", "6" = "#0072ce", "7" = "#af95a6", "8" = "#f7dea3",
  "9" = "#F1BE48", "10" ="#B7BF10", "11" = "#93328E", "12" = "#6CACE4",
  "13" = "#0072ce", "14" = "#f3bb90", "15" = "#000000", "16" = "#ff6a8d",
  "17" = "#66bbff", "18" = "#B7BF10"
)
