...
#      file = paste0("../unsupervised-integration-output/unsupervised_output_",
#                    i, ".RData"))
...
dimnames(theta) <- list(paste(as.character(2:maxK), "_clusters"),
                        rownames(CM),
                        c("CN", "Methylation", "miRNA", "RPPA") # "mRNA",
)
...
our_cl_palette <-  c(
  ...
  "5" = "#E47113", "6" = "#f7dea3", "7" = "#64A70B", "8" = "#f3bb90",
  "9" = "#0072ce"
)
...
pdf(paste0("../figures/unsupervised_cn", var_sel, ".pdf"))
HdataMatrix
dev.off()
...
pdf(paste0("../figures/unsupervised_methylation", var_sel, ".pdf"))
HdataMatrix
dev.off()
...
pdf(paste0("../figures/unsupervised_miRNA", var_sel, ".pdf"))
HdataMatrix
dev.off()
...
pdf(paste0("../figures/unsupervised_RPPA", var_sel, ".pdf"))
HdataMatrix
dev.off()
